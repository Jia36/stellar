    ...
    renderVideo = () => {
        ...
        >
            <View style={styles.iconContainer}>
                <Image source={require("../assets2/play-video.png")} style={{ width: 50, height: 50 }}></Image>
            </View>
        </TouchableOpacity >
    }
        ...
        if (Object.keys(this.state.apod).length === 0) {
            ...
            return (
                <View style={styles.container}>
                    ...
                    <ImageBackground source={require('../assets2/APOD.jpeg')} style={styles.backgroundImage}>
